 ...
 * @author Lourdes
 */
public class ProductosAdmi extends javax.swing.JInternalFrame {
public static TreeSet<Producto> listaProductos = new TreeSet <>();
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(jcRubro, 0, 97, Short.MAX_VALUE))))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void jbGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbGuardarActionPerformed
        ...
        if (rubro == Categoria.COMESTIBLES) {
        ...
        } else if (rubro == Categoria.LIMPIEZA) {
            listaProductos.add(new Producto(
                    Integer.parseInt(jtCodigo.getText()),
                    jtDescripcion.getText(),
                    Double.parseDouble(jtPrecio.getText()),
        ...
        } else if (rubro == Categoria.PERFUMERIA) {
            listaProductos.add(new Producto(
                    Integer.parseInt(jtCodigo.getText()),
                    jtDescripcion.getText(),
                    Double.parseDouble(jtPrecio.getText()),
    ...
    private void jbBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbBuscarActionPerformed
        ...
        for(Producto pro : listaProductos){
            if(pro.getCodigo() == codigo){
                ...
                jtPrecio.setText(Double.toString(pro.getPrecio()));
                jtStock.setText(Integer.toString(pro.getStock()));
            }
